...
export const RecipeRequestLanding = ({ requestId, onBack, source = 'recipe-bank' }: RecipeRequestLandingProps) => {
  ...
  const getWorkflowSteps = (requestData: any) => {
    // Special handling for REQ_141
    if (requestData.requestId === 'REQ_141' || (requestData.id && requestData.id === 'REQ_141')) {
      return [
        {
        ...
        },
        {
          ...
          description: "Approved by Bharti on Mar 18, 2025, 4:15pm",
          status: 'completed' as const,
          icon: CheckCircle,
          autoGeneratedRequest: {
            requestId: 'REQ_136',
            description: 'Request REQ_136 for Modification of impacted recipes was auto-generated by system & assigned to Chef'
          }
        }
      ];
    }
                  ...
                  <div key={index} className="relative">
                    ...
                    <div className={`relative flex items-start gap-6 p-6 rounded-xl transition-all duration-300 ${
                      ...
                      <div className="flex-1 min-w-0 pt-1">
                        ...
                        {/* Auto-generated request info */}
                        {(step as any).autoGeneratedRequest && (
                            ...
                            <div className="flex items-start gap-3">
                              ...
                              <div className="flex-1">
                                ...
                                <p className="text-sm text-blue-800 dark:text-blue-200 mb-3">
                                  {(step as any).autoGeneratedRequest.description}
                                </p>
                                <Button
                                  size="sm"
                                  onClick={() => navigate(`/recipe-request-landing?requestId=${(step as any).autoGeneratedRequest.requestId}&source=inventory-codes`)}
                                  className="bg-blue-600 hover:bg-blue-700 text-white"
                                >
                                  View Request {(step as any).autoGeneratedRequest.requestId}
                                </Button>
                              </div>
                            </div>
                          </div>
